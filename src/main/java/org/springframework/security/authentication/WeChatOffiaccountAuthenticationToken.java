 ...
 */
public class WeChatOffiaccountAuthenticationToken extends AbstractAuthenticationToken {
	...
	public WeChatOffiaccountAuthenticationToken(Collection<? extends GrantedAuthority> authorities,
		...
		this.authorizationGrantType = OAuth2WeChatOffiaccountAuthenticationToken.WECHAT_OFFIACCOUNT;
